...
### Most expensive paintings {#most-expensive-paintings}
...
#### Finding the data {#web-paintings-find}
...
```{r web-finding-data, echo=FALSE, eval=TRUE, out.width="100%", fig.align='center'}
...
#### Visualising {#web-paintings-visualise}
...
```{r paintings-plot, echo=FALSE, fig.align='center', fig.width=7, fig.height=4.5, fig.cap="The twelve highest prices in the scraped ranking, as paid on the day of sale and not inflation-adjusted."}
paintings %>%
...
### Student numbers at Viadrina {#student-numbers-at-viadrina}
...
#### Finding the data {#web-viadrina-find}
...
```{r web-finding-data-3, echo=FALSE, eval=TRUE, out.width="100%", fig.align='center'}
...
#### Visualising {#web-viadrina-visualise}
...
```{r viadrina-long-run-plot, fig.align='center', fig.width=8, fig.height=5, fig.cap="Viadrina's winter enrolment since 1992, with the dashed line showing where the national trend would have left it."}
...
### What scraping is good for {#what-scraping-is-good-for}
