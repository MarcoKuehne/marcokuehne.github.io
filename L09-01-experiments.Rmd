...
**The question that was never causal.** Some of the most useful numbers in economics are accounting, not causation. How much of the gender wage gap corresponds to measured differences in occupation, hours and experience is an **Oaxaca-Blinder decomposition** — the subject of Section \@ref(decomposing-differences) — and it is an entirely respectable exercise as long as nobody calls the unexplained remainder "discrimination". A decomposition apportions a difference. It does not say what would happen if you changed something.
