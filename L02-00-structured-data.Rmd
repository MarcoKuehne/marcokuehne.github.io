...
A fifth asks the remaining question: in what shape does the table arrive? Every file makes promises — about column types, about what the codes mean, about whether the thing is a rectangle at all. The last of those promises is the one that breaks, and that is where the following chapter begins.
...
```{r child-file-formats, child='L02-05-file-formats.Rmd'}
```