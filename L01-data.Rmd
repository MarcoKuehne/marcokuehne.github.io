...
The Socio-Economic Panel (SOEP) is a longitudinal survey of households in Germany that has been conducted annually since `r fitb(1984)`. The survey collects data on a wide range of socio-economic topics, including income, education, health, employment, and social and political attitudes.

The SOEP is one of the largest and longest-running household panel surveys in the world. Every year, approximately 30,000 people in 15,000 households are interviewed for the SOEP study.

The survey follows all members of a household. In addition to the annual survey, the SOEP also includes additional data collection on specific topics, such as health, education, and migration. 

<!-- The data collected by the SOEP has been used in a wide range of academic and policy research, both within Germany and internationally. The survey is particularly useful for studying long-term social and economic trends, as well as for examining the impacts of social and economic policies on households. -->
...
Let's hear from people working with SOEP data.
...
<!-- Pfeiler, T. M., & Egloff, B. (2020). Do vegetarians feel bad? Examining the association between eating vegetarian and subjective well-being in two representative samples. Food Quality and Preference, 86, 104018. -->
