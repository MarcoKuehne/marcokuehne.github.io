...
This book uses `R`. All concepts could have been implemented in `Python` as well and there is a future plan to translate some examples to Python. Both a versatile programming languages with an active community and a lot of free online resources. 
