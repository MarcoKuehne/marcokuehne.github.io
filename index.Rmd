...
css/ani.css, css/background.css]
...
<!-- Code-Folding in Bookdown https://statnmap.com/2017-11-13-enable-code-folding-in-bookdown-and-blogdown/ -->

```{r code-folding, echo=F, eval=F}
...
tippy::tippy_this(elementId = "discofox", tooltip = "World Championship 2022 in Warsaw")
```
...
Every chapters covers the content of a week. 
