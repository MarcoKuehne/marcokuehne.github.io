...
# =========================================================================
css: [www/webex.css, css/style.css, css/boxes.css, css/ani.css,
      css/background.css, css/toggle.css, css/wikipedia_link.css,
...
output:
  bookdown::gitbook:
    ...
    toc_depth: 2               #       Until then keep chapter / omit toc_depth.
