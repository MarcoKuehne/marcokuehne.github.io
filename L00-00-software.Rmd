...
`na.rm = TRUE` is a decision, not a formality. Chapter \@ref(missing-data) returns to what dropping those cases quietly assumes.
...
<h2> Amazing Fact </h2>
:::
That history tab is also a research tool, and it comes back in Chapter \@ref(web-data), where we scrape a Wikipedia table of the most expensive paintings ever sold.
