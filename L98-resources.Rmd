...
The works this book actually cites are a different list, generated from `references.bib` and kept on the [References](references.html#references) page. This one is for what to read next; that one is for what the argument rests on.
