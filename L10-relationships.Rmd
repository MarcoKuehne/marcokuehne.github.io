...
```{r dogs, echo=FALSE, out.width="100%", fig.cap="The first known pair in Finland (2015), representing a northward expansion compared to the species' historical breeding range.", fig.align='center'}
knitr::include_graphics("https://en.wikipedia.org/wiki/White_stork#/media/File:Haikara_(White_stork)_(1)_Koski_Tl._9.7.2015.jpg")
```
