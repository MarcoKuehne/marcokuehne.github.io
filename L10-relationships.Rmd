...
<div>
  <a href="https://github.com/MarcoKuehne/marcokuehne.github.io/raw/main/data/Storks/Storks_Clean.xlsx" download="your_file_name.xlsx" class="download-button" style="background-color: #007bff; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">
    <span class="icon">&#x2B07;</span> Download Stork Data (Excel Format)
  </a>
</div>
...
<a href="https://en.wikipedia.org/wiki/The_Correlation_between_Relatives_on_the_Supposition_of_Mendelian_Inheritance" target="_blank" class="wiki-link" style="background-color: #4CAF50; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">
<span class="icon">&#x1F4D6;</span> Visit Wikipedia Page
</a>
