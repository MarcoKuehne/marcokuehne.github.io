...
modelsummary(title = 'Logistic regression in default coefficients and odds ratio.',
             list("Survival" = logistic1,
                  "Survival (Odds Ratio)" = logistic1), 
             gof_omit = 'R2|AIC|BIC|RMSE|Log.Lik.|F',
             coef_map = cm,
...
```{r, eval=TRUE, echo=F}
modelsummary(title = 'Logistic regression in default coefficients and odds ratio.',
             list("Survival" = logistic2,
                  "Survival (Odds Ratio)" = logistic2), 
...
```{r, eval=TRUE, echo=F}
modelsummary(title = 'Logistic regression in default coefficients and odds ratio.',
             list("Survival" = logistic3,
                  "Survival (Odds Ratio)" = logistic3), 
...
modelsummary(title = 'Logistic regression comparison with model statistics.',
             ...
             #metrics = "all",
             coef_map = cm,
             exponentiate = c(FALSE,TRUE,FALSE,TRUE))
```
...
pred1 <- predict(logistic4_small, type = "response")
pred2 <- predict(logistic4_big, type = "response")
...
rocobj1 <-plot.roc(titanic$Survived, pred1,
                    main="Statistical comparison",
                    percent=TRUE,
                    col="#1c61b6")
rocobj2 <- lines.roc(titanic$Survived, pred2, 
                     percent=TRUE, 
                     col="#008600")
testobj <- roc.test(rocobj1, rocobj2)
text(50, 50, labels=paste("p-value =", 
                          format.pval(testobj$p.value)), adj=c(0, .5))
legend("bottomright", legend=c("Small Model", "Big Model"), 
